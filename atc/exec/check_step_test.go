		...
		Context("running", func() {
			...
			Describe("running the check step", func() {
				...
				JustBeforeEach(func() {
					...
					runCtx, owner, containerSpec, workerSpec, strategy, metadata, processSpec, startEventDelegate, resource, timeout, volumeFinder = fakeClient.RunCheckStepArgsForCall(0)
				})
